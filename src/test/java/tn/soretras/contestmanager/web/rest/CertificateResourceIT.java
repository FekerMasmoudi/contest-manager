...
class CertificateResourceIT {
    ...
    public static Certificate createEntity() {
        Certificate certificate = new Certificate().rank(DEFAULT_RANK).designation(DEFAULT_DESIGNATION);
        return certificate;
    }
    ...
    public static Certificate createUpdatedEntity() {
        Certificate certificate = new Certificate().rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        return certificate;
    }
    ...
    void createCertificate() throws Exception {
        ...
        assertThat(testCertificate.getRank()).isEqualTo(DEFAULT_RANK);
    ...
    void putExistingCertificate() throws Exception {
        ...
        updatedCertificate.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        ...
        Certificate testCertificate = certificateList.get(certificateList.size() - 1);
        assertThat(testCertificate.getRank()).isEqualTo(UPDATED_RANK);
    ...
    void partialUpdateCertificateWithPatch() throws Exception {
        ...
        partialUpdatedCertificate.rank(UPDATED_RANK);
    ...
    void fullUpdateCertificateWithPatch() throws Exception {
        ...
        partialUpdatedCertificate.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
