...
class SpecialityResourceIT {
    ...
    public static Speciality createEntity() {
        Speciality speciality = new Speciality().rank(DEFAULT_RANK).designation(DEFAULT_DESIGNATION);
        return speciality;
    }
    ...
    public static Speciality createUpdatedEntity() {
        Speciality speciality = new Speciality().rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        return speciality;
    }
    ...
    void createSpeciality() throws Exception {
        ...
        assertThat(testSpeciality.getRank()).isEqualTo(DEFAULT_RANK);
    ...
    void putExistingSpeciality() throws Exception {
        ...
        updatedSpeciality.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        ...
        Speciality testSpeciality = specialityList.get(specialityList.size() - 1);
        assertThat(testSpeciality.getRank()).isEqualTo(UPDATED_RANK);
    ...
    void fullUpdateSpecialityWithPatch() throws Exception {
        ...
        partialUpdatedSpeciality.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
