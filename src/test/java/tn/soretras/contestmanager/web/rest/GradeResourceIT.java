...
class GradeResourceIT {
    ...
    public static Grade createEntity() {
        Grade grade = new Grade().code(DEFAULT_CODE).designation(DEFAULT_DESIGNATION);
        // Add required entity
        Certificate certificate;
        certificate = CertificateResourceIT.createEntity();
        certificate.setId("fixed-id-for-tests");
        grade.setCertificate(certificate);
        // Add required entity
        Educationlevel educationlevel;
        educationlevel = EducationlevelResourceIT.createEntity();
        educationlevel.setId("fixed-id-for-tests");
        grade.setEducationlevel(educationlevel);
        return grade;
    }
    ...
    public static Grade createUpdatedEntity() {
        Grade grade = new Grade().code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
        // Add required entity
        Certificate certificate;
        certificate = CertificateResourceIT.createUpdatedEntity();
        certificate.setId("fixed-id-for-tests");
        grade.setCertificate(certificate);
        // Add required entity
        Educationlevel educationlevel;
    ...
    void putExistingGrade() throws Exception {
        ...
        updatedGrade.code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
    ...
    void fullUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
