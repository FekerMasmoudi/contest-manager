...
class SectorResourceIT {
    ...
    public static Sector createEntity() {
        Sector sector = new Sector().rank(DEFAULT_RANK).designation(DEFAULT_DESIGNATION);
        return sector;
    }
    ...
    public static Sector createUpdatedEntity() {
        Sector sector = new Sector().rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        return sector;
    }
    ...
    void createSector() throws Exception {
        ...
        assertThat(testSector.getRank()).isEqualTo(DEFAULT_RANK);
    ...
    void putExistingSector() throws Exception {
        ...
        updatedSector.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        ...
        Sector testSector = sectorList.get(sectorList.size() - 1);
        assertThat(testSector.getRank()).isEqualTo(UPDATED_RANK);
    ...
    void partialUpdateSectorWithPatch() throws Exception {
        ...
        partialUpdatedSector.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
