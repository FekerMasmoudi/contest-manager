...
class ContestfieldResourceIT {
    ...
    public static Contestfield createEntity() {
        ...
        contestfield.setContest(contest);
        return contestfield;
    }
    ...
    @Test
    void checkLogicIsRequired() throws Exception {
        int databaseSizeBeforeTest = contestfieldRepository.findAll().size();
        // set the field null
        contestfield.setLogic(null);
    ...
    void partialUpdateContestfieldWithPatch() throws Exception {
        ...
        partialUpdatedContestfield.reference(UPDATED_REFERENCE).ctype(UPDATED_CTYPE).logic(UPDATED_LOGIC);
