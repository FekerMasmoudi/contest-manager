...
class EducationlevelResourceIT {
    ...
    public static Educationlevel createEntity() {
        Educationlevel educationlevel = new Educationlevel().rank(DEFAULT_RANK).designation(DEFAULT_DESIGNATION);
    ...
    public static Educationlevel createUpdatedEntity() {
        Educationlevel educationlevel = new Educationlevel().rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        return educationlevel;
    }
    ...
    void createEducationlevel() throws Exception {
        ...
        assertThat(testEducationlevel.getRank()).isEqualTo(DEFAULT_RANK);
    ...
    void putExistingEducationlevel() throws Exception {
        ...
        updatedEducationlevel.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
        ...
        Educationlevel testEducationlevel = educationlevelList.get(educationlevelList.size() - 1);
        assertThat(testEducationlevel.getRank()).isEqualTo(UPDATED_RANK);
    ...
    void fullUpdateEducationlevelWithPatch() throws Exception {
        ...
        partialUpdatedEducationlevel.rank(UPDATED_RANK).designation(UPDATED_DESIGNATION);
