...
export class InputtextareaComponent implements OnInit {
  ...
  @Input() textInputarea!: Inputtextarea;
  ...
  settingsInput!: Inputtextarea;

  arrayResult: Inputtextarea[] = [];
  ...
  ondragended(event: CdkDragMove): void {
    this.textInputarea.positionInput = event.source.getRootElement().getBoundingClientRect();
