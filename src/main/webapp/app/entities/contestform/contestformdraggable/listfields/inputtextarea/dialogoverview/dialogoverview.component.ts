...
export class DialogoverviewComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<DialogoverviewComponent>, @Inject(MAT_DIALOG_DATA) public data: Inputtextarea) {}
  datacopy1!: Inputtextarea;
  ...
  ngOnInit(): void {
    ...
    const datacopy: Inputtextarea = this.data;
