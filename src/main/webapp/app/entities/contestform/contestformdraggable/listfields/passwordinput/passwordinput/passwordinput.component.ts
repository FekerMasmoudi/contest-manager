...
export class PasswordinputComponent implements OnInit {
  ...
  settingsInput!: Passwordinput;

  arrayResult: Passwordinput[] = [];
  ...
  ondragended(event: CdkDragMove): void {
    this.passwordInput.positionInput = event.source.getRootElement().getBoundingClientRect();
