...
export class DialogoverviewComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<DialogoverviewComponent>, @Inject(MAT_DIALOG_DATA) public data: Inputphone) {}
  datacopy1!: Inputphone;
  ...
  ngOnInit(): void {
    ...
    const datacopy: Inputphone = this.data;
