...
export class DialogoverviewComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<DialogoverviewComponent>, @Inject(MAT_DIALOG_DATA) public data: Emailinput) {}
  datacopy1!: Emailinput;
  ...
  ngOnInit(): void {
    ...
    const datacopy: Emailinput = this.data;
