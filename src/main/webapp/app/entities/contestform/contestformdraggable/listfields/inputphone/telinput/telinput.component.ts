...
import { MyTel } from '../inputphone/inputphone.component';

@Component({
  selector: 'jhi-telinput',
  templateUrl: './telinput.component.html',
  styleUrls: ['./telinput.component.scss'],
})
export class TelinputComponent implements ControlValueAccessor, MatFormFieldControl<MyTel>, OnDestroy {
  ...
  focused = false;
  touched = false;
  controlType = 'jhi-telinput';
  id = `jhi-telinput-${TelinputComponent.nextId++}`;
  onChange = (_: any) => {};
  onTouched = () => {};
