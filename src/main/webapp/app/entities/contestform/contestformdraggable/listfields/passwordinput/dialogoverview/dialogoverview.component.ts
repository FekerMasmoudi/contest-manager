...
export class DialogoverviewComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<DialogoverviewComponent>, @Inject(MAT_DIALOG_DATA) public data: Passwordinput) {}
  datacopy1!: Passwordinput;
  ...
  ngOnInit(): void {
    ...
    const datacopy: Passwordinput = this.data;
