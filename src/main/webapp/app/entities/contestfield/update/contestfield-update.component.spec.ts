...
describe('Contestfield Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Contest query and add missing value', () => {
      ...
      const contest: IContest = { id: '174c8b2e-5571-49cb-8d0c-be910e753e72' };
      contestfield.contest = contest;
    ...
    it('Should update editForm', () => {
      const contestfield: IContestfield = { id: 'CBA' };
      const contest: IContest = { id: 'fad65411-6110-4358-95b5-71718560f26e' };
      contestfield.contest = contest;
