...
type ContestannounceFormDefaults = Pick<NewContestannounce, 'id' | 'status' | 'generalrules'>;
...
type ContestannounceFormGroupContent = {
  ...
  status: FormControl<IContestannounce['status']>;
  generalrules: FormControl<IContestannounce['generalrules']>;
};
...
export class ContestannounceFormService {
  createContestannounceFormGroup(contestannounce: ContestannounceFormGroupInput = { id: null }): ContestannounceFormGroup {
    ...
    return new FormGroup<ContestannounceFormGroupContent>({
      ...
      generalrules: new FormControl(contestannounceRawValue.generalrules ?? []),
    });
  }
