...
describe('Contestannounce Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Generalrules query and add missing value', () => {
      ...
      const generalrules: IGeneralrules[] = [{ id: '6c99d282-ecec-4404-be9f-f42feb09d085' }];
      contestannounce.generalrules = generalrules;
      ...
      const additionalGeneralrules = [...generalrules];
    ...
    it('Should update editForm', () => {
      const contestannounce: IContestannounce = { id: 'CBA' };
      const generalrules: IGeneralrules = { id: '05fb6343-9f12-49cd-9d13-31cab968d401' };
      contestannounce.generalrules = [generalrules];

      activatedRoute.data = of({ contestannounce });
      comp.ngOnInit();

      expect(comp.generalrulesSharedCollection).toContain(generalrules);
