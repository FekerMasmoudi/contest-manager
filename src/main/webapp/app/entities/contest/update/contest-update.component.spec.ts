...
describe('Contest Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Contestannounce query and add missing value', () => {
      ...
      const contestannounce: IContestannounce = { id: '91e8ff94-8e2c-4eb4-b5fd-c4f754653bf0' };
      contest.contestannounce = contestannounce;
      ...
      const additionalContestannounces = [contestannounce];
    ...
    it('Should call Grade query and add missing value', () => {
      const contest: IContest = { id: 'CBA' };
      const grade: IGrade = { id: '7efe2803-45a5-4ff1-ad95-aecbcb4673af' };
      contest.grade = grade;
    ...
    it('Should call Speciality query and add missing value', () => {
      const contest: IContest = { id: 'CBA' };
      const speciality: ISpeciality = { id: 'a0762d6e-f835-4366-a4d7-fde3f854920d' };
      contest.speciality = speciality;
    ...
    it('Should call Sector query and add missing value', () => {
      const contest: IContest = { id: 'CBA' };
      const sector: ISector = { id: 'c8250a99-2135-41af-9024-97f6c1313bfb' };
      contest.sector = sector;
    ...
    it('Should update editForm', () => {
      const contest: IContest = { id: 'CBA' };
      const contestannounce: IContestannounce = { id: '41313d20-6542-46df-b257-3a5132a07d28' };
      contest.contestannounce = contestannounce;
      const grade: IGrade = { id: '8dec9910-6548-4822-9392-6cf6bba52a16' };
      contest.grade = grade;
      const speciality: ISpeciality = { id: '2115d1d3-2229-4dac-8817-1174d1105b08' };
      contest.speciality = speciality;
      const sector: ISector = { id: '9fa32bd1-f997-4f1d-b68c-7f79c0352872' };
      contest.sector = sector;

      activatedRoute.data = of({ contest });
      comp.ngOnInit();

      expect(comp.contestannouncesSharedCollection).toContain(contestannounce);
