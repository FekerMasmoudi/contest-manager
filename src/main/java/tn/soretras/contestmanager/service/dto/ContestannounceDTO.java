...
public class ContestannounceDTO implements Serializable {
    ...
    private Set<GeneralrulesDTO> generalrules = new HashSet<>();
    ...
    public Set<GeneralrulesDTO> getGeneralrules() {
        return generalrules;
    }

    public void setGeneralrules(Set<GeneralrulesDTO> generalrules) {
