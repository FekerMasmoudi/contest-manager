...
public class EducationlevelResource {
    ...
    public ResponseEntity<EducationlevelDTO> updateEducationlevel(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, educationlevelDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<EducationlevelDTO> partialUpdateEducationlevel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, educationlevelDTO.getId())
        );
    }
