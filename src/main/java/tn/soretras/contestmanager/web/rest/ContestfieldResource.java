...
public class ContestfieldResource {
    ...
    public ResponseEntity<ContestfieldDTO> updateContestfield(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestfieldDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ContestfieldDTO> partialUpdateContestfield(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestfieldDTO.getId())
        );
    }
