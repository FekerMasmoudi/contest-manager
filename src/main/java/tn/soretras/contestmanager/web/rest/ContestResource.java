...
/**
 * REST controller for managing {@link tn.soretras.contestmanager.domain.Contest}.
 */
@RestController
@RequestMapping("/api")
public class ContestResource {
    ...
    public ResponseEntity<ContestDTO> updateContest(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ContestDTO> partialUpdateContest(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestDTO.getId())
        );
    }
