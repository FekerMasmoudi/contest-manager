...
public class GeneralrulesResource {
    ...
    public ResponseEntity<GeneralrulesDTO> createGeneralrules(@Valid @RequestBody GeneralrulesDTO generalrulesDTO)
    ...
    public ResponseEntity<GeneralrulesDTO> updateGeneralrules(
        ...
        @Valid @RequestBody GeneralrulesDTO generalrulesDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, generalrulesDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<GeneralrulesDTO> partialUpdateGeneralrules(
        @PathVariable(value = "id", required = false) final String id,
        @NotNull @RequestBody GeneralrulesDTO generalrulesDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, generalrulesDTO.getId())
        );
    }
