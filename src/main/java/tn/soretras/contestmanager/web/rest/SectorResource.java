...
public class SectorResource {
    ...
    public ResponseEntity<SectorDTO> updateSector(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, sectorDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<SectorDTO> partialUpdateSector(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, sectorDTO.getId())
        );
    }
