...
public class ContestannounceResource {
    ...
    public ResponseEntity<ContestannounceDTO> updateContestannounce(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestannounceDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ContestannounceDTO> partialUpdateContestannounce(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, contestannounceDTO.getId())
        );
    }
