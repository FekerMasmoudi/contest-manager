...
public class SpecialityResource {
    ...
    public ResponseEntity<SpecialityDTO> updateSpeciality(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, specialityDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<SpecialityDTO> partialUpdateSpeciality(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, specialityDTO.getId())
        );
    }
